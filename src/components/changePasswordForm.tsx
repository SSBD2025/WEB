...
export function ChangePasswordForm() {
    ...
    const [pendingData, setPendingData] = useState<{ oldPassword?: string; newPassword?: string;  } | null>(null)
    ...
    if (pendingData && pendingData.oldPassword && pendingData.newPassword) {
      updateMePasswordMutation.mutate({ oldPassword: pendingData.oldPassword, newPassword: pendingData.newPassword }, {})
    ...
    return (
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>{t("profile.fields.oldPassword")}</FormLabel>
                            <FormControl>
                                <Input type="password" placeholder={t("profile.fields.oldPassword")} {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input type="password" placeholder={t("profile.fields.newPassword")} {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input type="password" placeholder={t("profile.fields.confirmPassword")} {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
        ...
        <AlertDialog open={isPasswordDialogOpen} onOpenChange={setIsPasswordDialogOpen}>
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle>{t("profile.fields.confirm_password_change_title")}</AlertDialogTitle>
                    <AlertDialogDescription>
