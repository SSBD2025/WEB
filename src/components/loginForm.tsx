...
type FormSchema = z.infer<typeof loginSchema> &
  Partial<Pick<z.infer<typeof twoFactorSchema>, "code">>;
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <RequiredFormLabel htmlFor="login" >Login</RequiredFormLabel>
                <FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <RequiredFormLabel htmlFor="password" >{t("login.password")}</RequiredFormLabel>
                <FormControl>
          ...
          {is2faRequired && (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <RequiredFormLabel htmlFor="code" >{t("2fa.label")}</RequiredFormLabel>
                  <FormControl>
