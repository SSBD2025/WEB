...
const formSchema = z.object({
  height: z
    ...
    .refine(
      (val) => {
        ...
        return !isNaN(num) && num > 0 && num >= 50 && num <= 250
      },
      {
  ...
  dietPreferences: z
    ...
    .max(10, t("permanent_survey_form.max_10_items")),
  allergies: z
    .array(
      z.object({
              ...
              <Accordion type="single" collapsible defaultValue="section-1" className="w-full">
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} value={field.value}>
                            <FormControl>
                              <SelectTrigger>
                                <SelectValue placeholder={t("permanent_survey_form.select_gender")} />
                              </SelectTrigger>
                            </FormControl>
                            <SelectContent>
                              <SelectItem value="1">{t("permanent_survey_form.gender_name.man")}</SelectItem>
                              <SelectItem value="0">{t("permanent_survey_form.gender_name.female")}</SelectItem>
                            </SelectContent>
                          </Select>
                          <FormMessage />
                        </FormItem>
                  ...
                  <AccordionContent className="space-y-6 pt-4">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <Label>{t("permanent_survey_form.diet_preferences")} (max 10)</Label>
                        <Button
                          type="button"
                          variant="outline"
                          size="sm"
                          ...
                          className="h-8"
                          disabled={dietPreferencesArray.fields.length >= 10}
                        >
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <Label>{t("permanent_survey_form.allergies")} (max 10)</Label>
                        <Button
                          type="button"
                          variant="outline"
                          size="sm"
                          ...
                          className="h-8"
                          disabled={allergiesArray.fields.length >= 10}
                        >
                          <Plus className="h-4 w-4 mr-1" /> {t("permanent_survey_form.add")}
                        </Button>
                      </div>
                ...
                <AccordionItem value="section-4">
                  ...
                  <AccordionContent className="space-y-6 pt-4">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <Label>{t("permanent_survey_form.illnesses")} (max 10)</Label>
                        <Button
                          type="button"
                          variant="outline"
                          size="sm"
                          ...
                          className="h-8"
                          disabled={illnessesArray.fields.length >= 10}
                        >
                          <Plus className="h-4 w-4 mr-1" /> {t("permanent_survey_form.add")}
                        </Button>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <Label>{t("permanent_survey_form.medications")} (max 10)</Label>
                        <Button
                          type="button"
                          variant="outline"
                          size="sm"
                          ...
                          className="h-8"
                          disabled={medicationsArray.fields.length >= 10}
                        >
                          <Plus className="h-4 w-4 mr-1" /> {t("permanent_survey_form.add")}
                        </Button>
                      </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>Minimum 10 znaków, maksimum 1000 znaków</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
